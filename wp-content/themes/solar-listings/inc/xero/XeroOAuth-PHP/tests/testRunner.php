...
function testLinks()
{
    ...
    if (isset($_SESSION['access_token']) || XERO_APP_TYPE == 'Private')
        echo '<ul>
        ...
        if (XERO_APP_TYPE == 'Partner')   echo '<li><a href="?refresh=1">Refresh access token</a></li>';
        if (XERO_APP_TYPE !== 'Private' && isset($_SESSION['access_token'])) {
            echo '<li><a href="?wipe=1">Start Over and delete stored tokens</a></li>';
        } elseif(XERO_APP_TYPE !== 'Private') {
