<?php $prefix = 'emails_booking_attraction_'; ?>
...
<div class="email-shortcodes">
	...
	<code title="<?php _e( 'Attraction URL', '7listings' ); ?>">[attraction_url]</code>
	<code title="<?php _e( 'Attraction Operator Title', '7listings' ); ?>">[title]</code>
	<code title="<?php _e( 'Attraction Item Title', '7listings' ); ?>">[resource]</code>
	<code title="<?php _e( 'Attraction Photo', '7listings' ); ?>">[resource_photo]</code>
