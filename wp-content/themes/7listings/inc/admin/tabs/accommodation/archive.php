...
<div class="sl-row">
	<div class="column-2">
		...
		<div class="sl-settings">
			<div class="sl-label">
				<label><?php _e( 'Type', '7listings' ); ?><?php echo do_shortcode( '[tooltip content="' . __( 'Page title for accommodation type archives', '7listings' ) . '" type="info"]<span class="icon"></span>[/tooltip]' ); ?></label>
			</div>
			<div class="sl-input">
		...
		<div class="sl-settings">
			<div class="sl-label">
				<label><?php _e( 'Amenity', '7listings' ); ?><?php echo do_shortcode( '[tooltip content="' . __( 'Page title for accommodation amenity archives', '7listings' ) . '" type="info"]<span class="icon"></span>[/tooltip]' ); ?></label>
			</div>
			<div class="sl-input">
				<input type="text" class="sl-input-large" name="<?php echo THEME_SETTINGS . "[{$post_type}_amenity_title]"; ?>" value="<?php echo esc_attr( sl_setting( "{$post_type}_amenity_title" ) ); ?>">
				<?php echo do_shortcode( '[tooltip content="' . __( 'For page title<br>use a SEO plugin like: Yoast', '7listings' ) . '" type="seo"]SEO[/tooltip]' ); ?>
			</div>
		</div>
		<div class="sl-settings">
		...
		<h2><?php _e( 'Accommodations', '7listings' ); ?></h2>
