...
$checkin  = get_post_meta( get_the_ID(), 'cancellpol', true );
$checkin  = $checkin ? $checkin : 6; // 10:00 am
$checkout = get_post_meta( get_the_ID(), 'cancellpol', true );
$checkout = $checkout ? $checkout : 12; // 2:00 pm
?>
<div class="sl-settings">
	<div class="sl-label">
		<label><?php _e( 'Check-In', '7listings' ); ?></label>
	</div>
	<div class="sl-input">
...
<div class="sl-settings">
	<div class="sl-label">
		<label><?php _e( 'Check-Out', '7listings' ); ?></label>
	</div>
	<div class="sl-input">
