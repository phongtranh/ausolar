<?php $prefix = 'emails_booking_rental_'; ?>
...
<div class="email-shortcodes">
	...
	<code title="<?php _e( 'Rental URL', '7listings' ); ?>">[rental_url]</code>
	<code title="<?php _e( 'Rental Title', '7listings' ); ?>">[title]</code>
	<code title="<?php _e( 'Booking Resource Title', '7listings' ); ?>">[resource]</code>
	<code title="<?php _e( 'Resource Photo', '7listings' ); ?>">[resource_photo]</code>
...
<span class="input-hint"><a target="_blank" href="<?php echo sl_email_preview_link( "{$prefix}guess_message", 'booking-rental' ); ?>"><?php _e( 'preview', '7listings' ); ?></a></span>
