...
<div class="sl-row">
	<div class="column-2">
		...
		<div class="sl-settings">
			<div class="sl-label">
				<label><?php _e( 'Type', '7listings' ); ?><?php echo do_shortcode( '[tooltip content="' . __( 'Page title for rental type archives', '7listings' ) . '" type="info"]<span class="icon"></span>[/tooltip]' ); ?></label>
			</div>
			<div class="sl-input">
		...
		<div class="sl-settings">
			<div class="sl-label">
				<label><?php _e( 'Feature', '7listings' ); ?><?php echo do_shortcode( '[tooltip content="' . __( 'Page title for rental features archives', '7listings' ) . '" type="info"]<span class="icon"></span>[/tooltip]' ); ?></label>
			</div>
			<div class="sl-input">
				<input type="text" class="sl-input-large" name="<?php echo THEME_SETTINGS . "[{$post_type}_features_title]"; ?>" value="<?php echo esc_attr( sl_setting( "{$post_type}_feature_title" ) ); ?>">
				<?php echo do_shortcode( '[tooltip content="' . __( 'For page title<br>use a SEO plugin like: Yoast', '7listings' ) . '" type="seo"]SEO[/tooltip]' ); ?>
			</div>
		</div>
		<div class="sl-settings">
		...
		<h2><?php _e( 'Rentals', '7listings' ); ?></h2>
