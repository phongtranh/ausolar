...
';
$tr_tpl    = '
	<tr class="%s" data-resource="%s" data-type="%s">
...
';
$prices    = array(
	1 => __( '1 Day', '7listings' ),
	2 => __( '2 Days', '7listings' ),
	3 => __( '3 Days', '7listings' ),
	4 => __( '4 Days', '7listings' ),
	5 => __( '5 Days', '7listings' ),
	6 => __( '6 Days', '7listings' ),
	7 => __( '7+ Days', '7listings' ),
);
...
foreach ( $resources as $index => $resource )
{
	...
	foreach ( $prices as $type => $label )
	{
		...
		foreach ( $values as $value )
		{
			...
			$price = sl_calculate_seasonal_price( $resource['price'][$type], $value );
...
$tr_tpl    = '
	<tr class="%s" data-resource="%s">
		...
		<td class="allo-new-allocation">
			<div class="input-append">
				<input type="text" name="%s" value="%s">
				<span class="add-on">' . __( 'units', '7listings' ) . '</span>
			</div>
		</td>
