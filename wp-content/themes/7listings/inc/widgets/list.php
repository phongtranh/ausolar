 ...
 */
class Sl_Widget_List extends WP_Widget
{
	/**
	...
	public $default = array(
		...
		'more_listings'       => 1,        // All
		'more_listings_style' => 'button', // All
	...
	public function __construct()
	{
		...
		parent::__construct(
			'sl-list',
			__( '7 - Posts', '7listings' ),
			array(
				'description' => __( 'List of posts or listings.', '7listings' ),
			)
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		if ( class_exists( $class ) )
			$html = call_user_func( array( $class, 'post_list' ), $instance );
		if ( ! $html )
			return;
	...
	public function form( $instance )
	{
		...
		<div class="sl-sub-settings">
			...
			<div class="sl-settings">
				...
				<div class="sl-input">
					<select name="<?php echo $this->get_field_name( 'more_listings_style' ); ?>" class="sl-input-small">
