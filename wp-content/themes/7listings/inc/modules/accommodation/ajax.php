...
/**
 * This class will hold all things for accommodation ajax requests
 */
class Sl_Accommodation_Ajax extends Sl_Core_Ajax
{
	/**
	...
	function get_max_date()
	{
		...
		$unbookable = Sl_Accommodation_Helper::get_unbookable_dates( $post_id, $find[1], $find[0] );
	...
	function get_total_price()
	{
		...
		while ( $from < $to )
		{
			$price = isset( $resource['price'] ) ? $resource['price'] : 0;
...
new Sl_Accommodation_Ajax( 'accommodation', array( 'get_max_date', 'get_total_price', 'add_booking' ) );
