...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
	<tr>
		<td style="border-bottom-width: 1px; border-bottom-color: <?php echo $row_border; ?>;; border-bottom-style: solid; border-collapse: collapse;">
			<h3 style="color: <?php echo $heading_color; ?>; display: block; font-family: Helvetica, Arial; font-size: 26px; font-weight: bold; line-height: 100%; text-align: left; margin-top: 20px; margin-right: 0; margin-bottom: 0px; margin-left: 0;" align="left">New message from contact form</h3>
		</td>
	</tr>
	<tr>
		<td class="bodyContent" style="border-collapse: collapse;">
			<div style="font-family: Helvetica, Arial;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>
							<h4 style="color: <?php echo $text_darker; ?>; font-size: 1.4em; padding-left: 4px;">[subject]</h4>
						</td>
					</tr>
					<tr>
						<td valign="top">
									...
									<td bgcolor="<?php echo $row_background; ?>" style="border-top:1px solid <?php echo $row_border; ?>;">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td>Phone</td>
												<td style="color: <?php echo $text_darker; ?>; border-collapse: collapse;" align="right">
													<strong>[customer-phone]</strong></td>
											</tr>
										</table>
									</td>
								</tr>
