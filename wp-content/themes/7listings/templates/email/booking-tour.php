			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="58%" valign="top" class="bodyContent" style="padding-top: 22px; border-collapse: collapse;">
						<h2 style="color: <?php echo $text_darker; ?>; display: block; font-size: 28px; font-weight: bold; line-height: 100%;">Dear [first_name]</h2>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="12">
				...
				<tr>
					<td colspan="2" class="bodyContent" style="border-collapse: collapse;">
						<div style="font-size: 14px; line-height: 150%; text-align: left;" align="left">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
								...
								<tr>
									<td valign="top" style="border-collapse: collapse;">
										<table width="100%" border="0" cellspacing="0" cellpadding="6">
											<tr>
												<td bgcolor="<?php echo $row_background; ?>" style="border-top:1px solid <?php echo $row_border; ?>; border-collapse: collapse;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td colspan="2" align="right" style="color: <?php echo $text_darker; ?>; border-collapse: collapse;">From:
											...
											<tr>
												<td style="border-top-width: 1px; border-top-color: <?php echo $row_border; ?>; border-top-style: solid; border-collapse: collapse;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
											...
											<tr>
												<td bgcolor="<?php echo $row_background; ?>" style="border-top-width: 1px; border-top-color: <?php echo $row_border; ?>; border-top-style: solid; border-collapse: collapse;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
				...
				<tr>
					<td colspan="2" align="left" class="bodyContent" style="border-collapse: collapse;"> [passengers_info]<br>
						<br>
						[message]
					</td>
				</tr>
