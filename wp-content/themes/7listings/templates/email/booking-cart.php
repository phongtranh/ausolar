	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse;"><!-- // Begin Template Body \\ -->
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="58%" valign="top" class="bodyContent" style="padding-top: 22px; border-collapse: collapse;">
						<div style="margin-left: 0; color: #505050; font-size: 14px; line-height: 150%; text-align: left;" align="left">
							<h2 style="color: <?php echo $text_darker; ?>; display: block; font-size: 28px; font-weight: bold; line-height: 100%;">Dear [first_name]</h2>
							<p>Thank You, for booking with [site-title]. <br>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="12">
				...
				<tr>
					<td class="bodyContent" style="border-collapse: collapse;" colspan="2">[booking_items]</td>
				</tr>
			</table>
