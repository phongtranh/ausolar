...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td colspan="2" align="right" style="color: <?php echo $text_darker; ?>; border-collapse: collapse;">From:
													<strong>[depart_time]</strong> To: <strong>[arrival_time]</strong>
												</td>
											</tr>
										</table>
									</td>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td align="right" valign="top" style="color: <?php echo $text_darker; ?>; border-collapse: collapse;">
													<strong>[passengers] - [subtotal_guests] AUD</strong></td>
											</tr>
										</table>
									</td>
								</tr>
	...
	<tr>
		<td class="bodyContent" style="border-collapse: collapse;" align="left"> [passengers_info]<br>
			<br>
			[message]
		</td>
	</tr>
