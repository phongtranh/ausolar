...
<div id="booking-wrapper">
	<div id="booking-single">
		...
		<div id="payment-details">
			...
			<hr />
			<div id="payment-date-amount"><?php echo get_the_time( "{$date_format} {$time_format}", get_the_ID() ); ?>
				<br>
					...
					<table width="360" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="204" align="right"><p style="text-align:right">
									<strong><?php echo sl_booking_meta( 'checkin' ); ?></strong></p>
							</td>
						</tr>
						<tr>
							<td width="140">Checkout</td>
							<td width="204" align="right"><p style="text-align:right">
									<strong><?php echo sl_booking_meta( 'checkout' ); ?></strong></p>
							</td>
						</tr>
					</table>
				</td>
