...
/*-------------------------------------------------------------
 ...
 Since:		3.12.4
-------------------------------------------------------------*/
function adrotate_group_output($group_ids, $fallback = 0, $weight = 0, $site = 0) {
}
...
function adrotate_custom_scripts() {
	...
	if(get_option('adrotate_dynamic_required') > 0) wp_enqueue_script('adrotate-dyngroup', plugins_url('/library/jquery.adrotate.dyngroup.js', __FILE__), false, '0.7', $in_footer);
	if(get_option('adrotate_responsive_required') > 0) wp_enqueue_script('adrotate-responsive', plugins_url('/library/jquery.adrotate.responsive.js', __FILE__), false, '0.4', $in_footer);
	if($adrotate_config['adblock'] == 'Y') wp_enqueue_script('adrotate-adblock', plugins_url('/library/jquery.adrotate.adblock.js', __FILE__), false, '0.1', $in_footer);

	// Make clicktracking and impression tracking a possibility
	if($adrotate_config['enable_stats'] == 'Y'){
		wp_enqueue_script('adrotate-clicktracker', plugins_url('/library/jquery.adrotate.clicktracker.js', __FILE__), false, '0.7', $in_footer);
...
function adrotate_custom_javascript() {
	...
	$groups = $wpdb->get_results("SELECT `id`, `adspeed`, `modus` FROM `".$wpdb->prefix."adrotate_groups` WHERE `name` != '' AND `modus` = 1 ORDER BY `id` ASC;");
	if($groups) {
...
function adrotate_help_info() {
    ...
    $screen->add_help_tab(array(
        ...
        'content' => '<h4>'.__('Useful links to learn more about AdRotate', 'adrotate').'</h4>'.
			'<ul>'.
			'<li><a href="https://ajdg.solutions/products/adrotate-for-wordpress/?utm_source=adrotate_pro&utm_medium=adrotate_help_tab&utm_campaign=adrotate_link" target="_blank">'.__('AdRotate Page', 'adrotate').'</a>.</li>'.
			'<li><a href="https://ajdg.solutions/manuals/adrotate/getting-started-with-adrotate/?utm_source=adrotate_pro&utm_medium=adrotate_help_tab&utm_campaign=manuals" target="_blank">'.__('Getting Started With AdRotate', 'adrotate').'</a>.</li>'.
			'<li><a href="https://ajdg.solutions/manuals/adrotate/?utm_source=adrotate_pro&utm_medium=adrotate_help_tab&utm_campaign=manuals" target="_blank">'.__('AdRotate manuals', 'adrotate').'</a>.</li>'.
			'<li><a href="https://ajdg.solutions/forums/forum/adrotate-for-wordpress/?utm_source=adrotate_pro&utm_medium=adrotate_help_tab&utm_campaign=support" target="_blank">'.__('AdRotate Support Forum', 'adrotate').'</a>.</li>'.
...
function adrotate_credits() {
	...
	echo '<td><center><a href="https://ajdg.solutions/?utm_source=adrotate_pro&utm_medium=adrotate_credits&utm_campaign=ajdg_link" title="AJdG Solutions"><img src="'.plugins_url('/images/ajdg-logo-100x60.png', __FILE__).'" alt="ajdg-logo-100x60" width="100" height="60" /></a></center></td>';
	echo '<td><a href="https://ajdg.solutions/?utm_source=adrotate_pro&utm_medium=adrotate_credits&utm_campaign=ajdg_link" title="AJdG Solutions">AJdG Solutions</a> - '.__('Your one stop for Webdevelopment, consultancy and anything WordPress! Find out more about what I can do for you!', 'adrotate').' '.__('Visit the', 'adrotate').' <a href="https://ajdg.solutions/?utm_source=adrotate_pro&utm_medium=adrotate_credits&utm_campaign=ajdg_link" target="_blank">AJdG Solutions</a> '.__('website', 'adrotate').'</td>';
	echo '</tr>';
	echo '</tbody>';
