...
if($ad_edit_id) {
	if($edit_banner->type != 'empty') {
		...
		if($edit_banner->tracker == 'N' AND $saved_user > 0) 
			echo '<div class="error"><p>'. __('You have set an advertiser but didn\'t enable clicktracking!', 'adrotate').'</p></div>';
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
      	<tr>
	        ...
	        <td colspan="2">
	        	<label for="adrotate_title"><input tabindex="1" name="adrotate_title" type="text" size="50" class="search-input" value="<?php echo stripslashes($edit_banner->title);?>" autocomplete="off" /> <em><?php _e('Visible to Advertisers!', 'adrotate'); ?></em></label>
	        </td>
      	</tr>
      	<tr>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
      	<tr>
	        ...
	        <td colspan="3">
	        	<label for="adrotate_responsive"><input tabindex="23" type="checkbox" name="adrotate_responsive" <?php if($edit_banner->responsive == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Enable responsive support for this advert.', 'adrotate'); ?></label><br />
      	...
      	<tr>
	        ...
	        <td colspan="3">
	        	...
	        	&nbsp;<input type="radio" tabindex="24" name="adrotate_weight" value="2" <?php if($edit_banner->weight == "2") { echo 'checked'; } ?> />&nbsp;&nbsp;&nbsp;2, <?php _e('Barely visible', 'adrotate'); ?><br />
	        	&nbsp;<input type="radio" tabindex="25" name="adrotate_weight" value="4" <?php if($edit_banner->weight == "4") { echo 'checked'; } ?> />&nbsp;&nbsp;&nbsp;4, <?php _e('Less than average', 'adrotate'); ?><br />
	        	&nbsp;<input type="radio" tabindex="26" name="adrotate_weight" value="6" <?php if($edit_banner->weight == "6") { echo 'checked'; } ?> />&nbsp;&nbsp;&nbsp;6, <?php _e('Normal coverage', 'adrotate'); ?><br />
	        	&nbsp;<input type="radio" tabindex="27" name="adrotate_weight" value="8" <?php if($edit_banner->weight == "8") { echo 'checked'; } ?> />&nbsp;&nbsp;&nbsp;8, <?php _e('More than average', 'adrotate'); ?><br />
	        	&nbsp;<input type="radio" tabindex="28" name="adrotate_weight" value="10" <?php if($edit_banner->weight == "10") { echo 'checked'; } ?> />&nbsp;&nbsp;&nbsp;10, <?php _e('Best visibility', 'adrotate'); ?>
	        	</label>
			</td>
		</tr>
      	<tr>
	...
	<table class="widefat" style="margin-top: .5em">	
		...
		<tbody>
      	...
      	<tr>
	        ...
	        <td colspan="3"><label for="adrotate_budget"><input tabindex="35" name="adrotate_budget" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->budget;?>" /><em><?php _e('When this reaches 0, the advert will expire.', 'adrotate'); ?></em></label></td>
      	</tr>
      	<tr>
	        <th width="15%"><?php _e('Click Rate:', 'adrotate'); ?></th>
	        <td><label for="adrotate_crate"><input tabindex="33" name="adrotate_crate" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->crate;?>" /><em><?php _e('Cost per click', 'adrotate'); ?></em></label></td>
	        <th width="15%"><?php _e('Impression Rate:', 'adrotate'); ?></th>
	        <td><label for="adrotate_irate"><input tabindex="34" name="adrotate_irate" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->irate;?>" /><em><?php _e('Cost per impression', 'adrotate'); ?></em></label></td>
      	</tr>
      	</tbody>
