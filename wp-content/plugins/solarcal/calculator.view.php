...
function ssc_shortcode( $atts )
{
    ...
    <div class="solar-calculator" ng-app="Calculator">
                    ...
                    <div class="form-data row-fluid">
                        <div class="span6">
                            ...
                            <div class="flex-text back-style-1 marg-div1 retail-price">                                
                                ...
                                <label class="control-label feed-in-tariff">Feed In Tariff</label>
                                <span class="controls">
                            ...
                            <div class="flex-text back-style-1 marg-div1 last-bill">
                                ...
                                <span class="input span-wight">
                                    <input type="number" step="any" class="span4 last-bill-number" ng-model="data.last_bill_amount" placeholder="$0.00"/>
	                                ...
	                                <div class="ssc_pitch ssc-field1">
	                                    <div class="position">
	                                        <div class="calculator-preview">
	                                            <span ng-style="{'background': 'url(/wp-content/plugins/solarcal/images/systemsize' + data.system_size + '.png) no-repeat'}"></span>
	                                        </div>
	                                    </div>
	                    ...
	                    <div class="systemInstallation span6">
	                        ...
	                        <div class="system-orientation">
	                            ...
	                            <div class="roof-pitch">
									...
									<span class="pitch">
									  <div class="preview">
									  	<span ng-style="{'background':'url(/wp-content/plugins/solarcal/images/roof_pitch_' + data.pitch + '.png) no-repeat'}"></span>
									  </div>
                    ...
                    <div id="chart">
                        <div id="bars">
                        	<div class="bar" ng-repeat="(year, value) in output.chart.bills">
                        		<div title="Bill without Solar = ${{value | number:2}}" ng-style="{'height': (value-output.graph_min)/(output.graph_max-output.graph_min)*100 + '%'}"></div>
                                <div title="Bill with Solar = ${{output.chart.solar[year] | number:2}} (Savings ${{output.chart.savings[year] | number:2}})" ng-style="{'height': (output.chart.solar[year]-output.graph_min)/(output.graph_max-output.graph_min)*100 + '%'}"></div>
                        	</div>
                        </div>
                    ...
                    <div id="result-stats" class="row-fluid">
                        <div class="span6">
                            <fieldset class="estimated-production">
                                ...
                                <div class="flex-text">
                                    <label class="control-label">Electricity exported</label>
                            ...
                            <fieldset>
                                ...
                                <div class="flex-text">
                                    <label class="control-label">Anual savings</label>
                        ...
                        <div class="span6">
                            <fieldset>
                                ...
                                <div class="flex-text">
                                    <label class="control-label">Price without solar</label>
                                    <span class="uneditable-input span6">
                                    	<strong class="retailerPriceKWH">{{data.retail_price | number:2}} c/kWh</strong>
                                    </span>
                                </div>
                                <div class="flex-text">
                                    <label class="control-label">Price with solar</label>
                                    <span class="uneditable-input span6">
                            ...
                            <fieldset>
                                ...
                                <div class="flex-text">
                                    <label class="control-label">Power bill - without solar</label>
                                    <span class="uneditable-input span6">
                                    	<strong id="electricityCostsNoSolar">${{output.without_solar_bill | number:2}}</strong>
                                    </span>
                                </div>
                                <div class="flex-text">
                                    <label class="control-label">Power bill - with solar</label>
                                    <span class="uneditable-input span6">
                                    	<strong id="electricityCostsSolar">${{output.with_solar_bill | number:2}}</strong>
                                    </span>
                                </div>
                                <div class="flex-text">
                                    <label class="control-label">Power bill savings</label>
                                    <span class="uneditable-input span6">
        ...
        <?php if(is_page( 20064 )): ?>
        	<a href="https://www.australiansolarquotes.com.au/fba-solar-quotes/"><img src="https://www.australiansolarquotes.com.au/wp-content/themes/solar-listings/images/ASQ_Web_Banner-728x122-n2-v2.png" style="width:100%"></a>
        <?php else: ?>
