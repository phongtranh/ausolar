...
function gct_testimominal_custom_scripts() {
	...
	if ( strstr($post->post_content, '[full-testimonials') ) {
		add_action('wp_footer', 'gct_custom_pagination',1000);
...
function gct_get_create_testimonial_form($error = '', $success = '', $gct_client_name = '', $gct_email = '', $gct_company_name = '', $gct_company_website = '', $gct_headline = '', $gct_text = '', $gct_agree = '', $gct_client_photo = '') {
	...
	$html .= '
		<p class=" form-field">
			<label for="gct_client_name">'.__("Name", GCT_NAME).' <span class="req">*</span></label>
		...
		<p class=" form-field">
			<label for="gct_headline">'.__("Headline", GCT_NAME).'</label>
			<input type="text" value="' . $gct_headline . '" name="gct_headline" id="gct_headline" class="text" /><br />
			<?php /*?><span class="headline-description">'.__("Describe our company in a few short words", GCT_NAME).'</span><?php */?>
		</p>

		<p class=" form-field">
			<label for="gct_text">'.__("Testimonial", GCT_NAME).' <span class="req">*</span></label>
			<textarea name="gct_text" id="gct_text" class="textarea  required">' . $gct_text . '</textarea>
		</p>
		...
		<p class=" form-field">
			...
			<input type="file" name="gct_client_photo" id="gct_client_photo" value="' . $gct_client_photo . '" class="text" /></p>
		...
		<p class="form-field">
			<input type="submit" id="gct_submit_testimonial" name="gct_submit_testimonial" value="'.__("Add my Testimonial", GCT_NAME).'" class="button" validate="required:true" />
		</p>
	';
...
class GCT_Testimonial_Menu_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if (is_active_widget( '', '', 'gc-testimonial-widget' )) {
			...
			// add_action('wp_footer', 'gct_widget_code',1000);
		}
	...
	if ($data['more'] == 'yes') {
		...
		echo '<p class="gctst-widget-readmore"><a href="'.$link.'" class="button small">'. __('Read More Testimonials', GCT_NAME) .' &#187;</a></p>';
	}
