	...
	public static function get_form( $form_id, $display_title = true, $display_description = true, $force_display = false, $field_values = null, $ajax = false, $tabindex = 1 ) {
		...
		if ( empty( $confirmation_message ) ) {
			...
			if ( $display_title || $display_description ) {
				...
				$form_string .= "
                        <div class='gform_heading {$modal_header}'>";
				if ( $display_title ) {
					$form_string .= "
			...
			$form_string .= "
                        <div class='gform_body {$modal_body}'>";
			...
			if ( ! $has_pages ) {
				...
				$form_string .= self::gform_footer( $form, 'gform_footer' .$modal_footer . $form['labelPlacement'], $ajax, $field_values, '', $display_title, $display_description, $tabindex );
			}
