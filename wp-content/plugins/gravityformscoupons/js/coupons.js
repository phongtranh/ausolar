...
function GetDiscount(couponType, couponAmount, price, totalDiscount) {
    ...
    discount = gform.applyFilters( 'gform_coupons_discount_amount', discount, couponType, couponAmount, price, totalDiscount );
...
function DeleteCoupon (code,formId){
    ...
    jQuery("#gf_coupon_codes_" + formId).val(coupon_codes.join(",")).change();
