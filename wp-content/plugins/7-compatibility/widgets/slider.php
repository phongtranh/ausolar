 ...
 */
class Sl_Widget_Compatibility_Slider extends Sl_Compatibility_Widget
{
	/**
	...
	function widget( $args, $instance )
	{
		...
		$html     = call_user_func( array( 'Sl_' . ucfirst( $this->post_type ) . '_Frontend', 'slider' ), $instance );
		if ( ! $html )
			return;
	...
	function form( $instance )
	{
		...
		<div class="sl-admin-widget">
			<p>
				...
				<input class="widefat widget-title" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $instance['title']; ?>">
			</p>
			<hr class="light">
